package tech.studiozebra.pytniznaci.utilities;
...
public class GDPR {
    ...
    public static void updateConsentStatus(final Activity act) {
        ...
        consentInformation.requestConsentInfoUpdate(new String[]{act.getString(tech.studiozebra.pytniznaci.R.string.admob_publisher_id)}, new ConsentInfoUpdateListener() {
            @Override
    ...
    private static class GDPRForm {
        ...
        private URL getUrlPrivacyPolicy(Activity act) {
            URL mUrl = null;
            try {
                mUrl = new URL(act.getString(tech.studiozebra.pytniznaci.R.string.privacy_policy_url));
