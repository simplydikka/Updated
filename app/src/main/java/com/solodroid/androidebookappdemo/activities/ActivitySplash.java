...
public class ActivitySplash extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //finds the layouts from the container
        ...
        //changes if last page and if so button leads to homescreen
    ...
    //checks if first time launch, sets the activity to start after final page
