package com.solodroid.androidebookappdemo.utilities;
	...
	// Creating Tables
			...
			public	void AddtoFavorite(ItemFavorite pj)
			{
				...
				values.put(KEY_CATEGORYNAME, pj.getBookName());
 				values.put(KEY_NEWSHEADING, pj.getStoryTitle());
				values.put(KEY_NEWSIMAGE, pj.getStoryImage());
				values.put(KEY_NEWSDESC, pj.getStoryDescription());
				values.put(KEY_NEWSDATE, pj.getStorySubTitle());
